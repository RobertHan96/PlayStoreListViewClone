...
//        val starOneImg = row.findViewById<TextView>(R.id.starOneImg)
//        val starTwoImg = row.findViewById<TextView>(R.id.starTwoImg)
//        val starThreeImg = row.findViewById<TextView>(R.id.starThreeImg)
//        val starFourImg = row.findViewById<TextView>(R.id.starFourImg)
//        val starFiveImg = row.findViewById<TextView>(R.id.starFiveImg)
//
